    ...
    function tt(dd){
   	 $.ajax({
 		...
 		success : function(data) {
			...
			{
				var item = list[i];
		<%--	var _detail = '<li><span>['+item.update_time+']</span><a href="http://218.87.30.159:8080/XDWeb/getNotice?articleId='+item.id+'" target="_blank">'+item.title+'</a></li>';--%>
		var _detail = '<li><span>['+item.update_time+']</span><a href="http://218.87.30.159:8080/XDWeb/getNotice?articleId='+item.id+'" target="_blank">'+item.title+'</a></li>';
