...
<html>
	...
	function deleteWageList(logId) {
		if (confirm('您确定要删除此次导入的数据吗 ?')) {
			var year = $("#year").val();
			var month = $("#month").val();
			var selwageType = $("#selwageType").val();
			var url = 'deleteWageList/' + logId + '?year=' + year + '&month='
					+ month + '&selwageType=' + selwageType;
			window.location.href = url;
		}
	}
	function enableWageList(logId) {
		if (confirm('您确定操作 ?')) {
			var year = $("#year").val();
			var month = $("#month").val();
			var selwageType = $("#selwageType").val();
			var url = 'enableWageList/' + logId + '?year=' + year + '&month='
					+ month + '&selwageType=' + selwageType;
			window.location.href = url;
		}
			...
			<div class="main">
				<div class="left">
					...
					<div class="nav2">
						<ul>
							<li class="dr">
								<a href="WageList">工资导入</a>
							</li>
							<li class="rz">
								<a href="WageListLog" class="current">导入日志</a>
							</li>
						</ul>
					</div>
				</div>
				<div class="right">
					<div class="menu">
						<strong>位置:工资管理 > 导入日志</strong>
					</div>
					<div class="list nostyle">
						<div class="zhushi">
							注：点击"删除此次更新的数据"按钮，将删除此时间导入数据，"删除"按钮，则删除本条日记记录
						</div>
						...
						<!-- 
            <div class="pages">
                <div class="num">总计<strong>1256</strong>条记录，当前显示第&nbsp;<strong>2</strong>页！</div>
                <div class="pageNum">
                    <span><a href="#">首页</a></span>
                    <span><a href="#">上一页</a></span>
                    <span><a href="#" class="curPage">1</a></span>
