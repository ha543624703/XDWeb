...
public class HibernateDao<T, PK extends Serializable> extends
	...
	protected Criterion buildPropertyFilterCriterion(final String propertyName,
		...
		Object pValue = null;
		try {
			pValue = HibernateWebUtils.convertValue(value, ReflectionUtils
					.getFieldFinalClass(entityClass, propertyName));
			// System.out.println("转换后的值："+pValue);
			if (MatchType.EQ.equals(matchType)) {
				...
				criterion = Restrictions.ne(propertyName, pValue);
