...
public class ReflectionUtils {
	...
	public static Class getFieldFinalClass(final Class entityClass,
			final String propertyName) {
		Class entiClassClone = entityClass;
		try {
			String[] fields = propertyName.split("\\.");
			for (int i = 0; i < fields.length; i++) {
				entiClassClone = entiClassClone.getDeclaredField(fields[i])
						.getType();
			}
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
		return entiClassClone;
	}
