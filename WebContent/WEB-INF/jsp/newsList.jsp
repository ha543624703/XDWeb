...
<div class="main">
 ...
 <div class="navMenu">
        <div class="navBox">
            <div class="navTitles"><strong>学院新闻</strong></div>
            <div class="navData">
                <ul>
        ...
        <div class="navBox h20">
            ...
            <div class="navList">
                <ul>
                    <c:forEach var="item" items="${listnew}" varStatus="status" begin="0"> 
    ...
    <div class="conList">
        <div class="listNav"><strong>学院新闻</strong></div>
   	 ...
   	 $.ajax({
 		...
 		success : function(data) {
			...
			for (var i=0; i<list.length; i++)
			{
				...
				var _detail = '<li><span>['+item.update_time+']</span><a href="http://218.87.30.159:8080/XDWeb/getNew?articleId='+item.id+'" target="_blank">'+item.title+'</a></li>';
